            ...
            <div class="row mb-5 mt-5">
                ...
                <div class="col-8 ps-5">
                    <div class="form-group mb-3">
                        <h5>Kategori</h5>
                        <select class="w-100 form-control" name="category_id" id="category_id"  onChange="category(this.value)">
                    ...
                    <div class="form-group mb-3">
                        <h5>Adet</h5>
                        <input type="text" name="product_stok" class=" form-control w-50">
                    </div>
                    <div class="form-group mb-3">
                        <h5>Fiyat</h5>
                        <input type="text" name="product_price" class=" form-control w-50">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                success: function(data) {
                    ...
                    data.forEach(variant => {
                        $("#product_options").append(
                                ...
                                " <span class='input-group-text' style='min-width: 130px;'>" + variant.value + "</span>" +
